...
bp = Piece('b', 'p', 'Assets/bp.png')
wp = Piece('w', 'p', 'Assets/wp.png')
bk = Piece('b', 'k', 'Assets/bk.png')
wk = Piece('w', 'k', 'Assets/wk.png')
br = Piece('b', 'r', 'Assets/br.png')
wr = Piece('w', 'r', 'Assets/wr.png')
bb = Piece('b', 'b', 'Assets/bb.png')
wb = Piece('w', 'b', 'Assets/wb.png')
bq = Piece('b', 'q', 'Assets/bq.png')
wq = Piece('w', 'q', 'Assets/wq.png')
bkn = Piece('b', 'kn', 'Assets/bkn.png')
wkn = Piece('w', 'kn', 'Assets/wkn.png')
